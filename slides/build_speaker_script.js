...
// ---- Slide 4 ----
children.push(SLIDE(4, "The model — three layers", "1.5 min"));
children.push(P("The model has three layers, and this one picture shows all of them. The dashed orange line is layer one: the hidden true probability. It drifts every period as a bounded random walk — and no trader ever sees it. The blue line is layer two: the observed market price, which is the truth plus error. That's the only thing our trading strategies are allowed to look at. And at the end of the horizon comes layer three: settlement — the contract pays one dollar with exactly the hidden probability at expiry."));
children.push(DIRECTION("Point at the dashed line, then the blue line, then the star at settlement."));
children.push(P("The green line is the trading strategy's own estimate — a smoothed average of the price — and that little triangle is where it decided to buy. Profit is payout minus entry price. Notice what this design guarantees: a strategy can only make money by systematically buying below true value. It cannot profit by predicting noise, because settlement is graded against the truth."));

// ---- Slide 5 ----
children.push(SLIDE(5, "Layer 1 — the hidden truth", "1 min"));
...
// ---- Slide 6 ----
children.push(SLIDE(6, "Layer 2 — two price mechanisms", "1.5 min"));
...
// ---- Slide 7 ----
children.push(SLIDE(7, "The trading policies", "1 min"));
...
// ---- Slide 8 ----
children.push(SLIDE(8, "Why trust the numbers", "1.5 min"));
...
// ---- Slide 9 ----
children.push(SLIDE(9, "Experiment design", "1 min"));
...
// ---- Slide 10 ----
children.push(SLIDE(10, "Baseline results", "1.5 min"));
...
// ---- Slide 11 ----
children.push(SLIDE(11, "Headline — how much persistence?", "1.5 min"));
